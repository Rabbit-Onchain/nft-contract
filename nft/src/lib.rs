...
NOTES:
  ...
  - To prevent the deployed contract from being modified or deleted, it should not have any access
    keys on its account.
*/
use constants::{FIVE_NEAR, ONE_NEAR, TEN_NEAR};
...
pub struct Contract {
    ...
    pub token_metadata_extend: UnorderedMap<TokenId, TokenMetadataExtend>,
}
...
impl Contract {
    ...
    pub fn new(owner_id: AccountId, metadata: NFTContractMetadata) -> Self {
        ...
        Self {
            ...
            token_metadata_extend: UnorderedMap::new(StorageKey::TokenMetadataExtend),
        }
    }
}
